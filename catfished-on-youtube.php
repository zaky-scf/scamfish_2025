<?php
    /**
    * Catfished on Youtube Category Template
    */
...
<div class="scfb-latest">
    <div class="container">
        <h2><?php echo single_cat_title( '', false ); ?></h2>
        <div class="row">
            <?php
                $category_posts1 = get_posts( array( 'numberposts' => 1, 'category' => $current_page->term_id, 'order' => 'DESC', ) );
            ...
            ?>
                <div class="col-md-6">
                    <div class="single-latest">
                        <a href="<?php echo get_permalink( $row->ID ); ?>" class="scfb-play-icon"><img src="<?php echo $img_url; ?>" data-src="<?php echo $img_url; ?>" style="background-image: url(<?php echo $img_url; ?>);" alt="<?php echo $row->post_title; ?>" decoding="async" loading="lazy" /></a>
            ...
            <div class="col-md-6">
                ...
                <?php
                    $category_posts2 = get_posts( array( 'numberposts' => 4, 'category' => $current_page->term_id, 'order' => 'DESC', ) );
        ...
        <?php
            ...
            ?>
                            ...
                            <div class="scfb-post-item">
                                <div class="row">
                                    <div class="col-md-4">
                                        <a href="<?php echo get_permalink(); ?>" class="scfb-play-icon"><img src="<?php echo $img_url; ?>" data-src="<?php echo $img_url; ?>"  style="background-image: url(<?php echo $img_url; ?>);" alt="<?php echo get_the_title(); ?>" decoding="async" loading="lazy" /></a>
                                    </div>
                                    <div class="col-md-8">
